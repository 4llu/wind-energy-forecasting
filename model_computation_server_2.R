...
post_w10_w100_t2m_log_year <- stan_glmer(log_energy ~ w10 + w100 + t2m + (w10 + w100 + t2m | region) + (w10 + w100 + t2m | season),
...
# Save the fit
save(post_w10_w100_t2m_log_year, file = "post_w10_w100_t2m_log_year.rda")
print(post_w10_w100_t2m_log_year)



## w10 + w100, log target, ts=6, year

post_w10_w100_t2m_log_year_ts6 <- stan_glmer(log_energy ~ w10 + w100 + t2m + (w10 + w100 + t2m | region) + (w10 + w100 + t2m | season),
...
# Save the fit
save(post_w10_w100_t2m_log_year_ts6, file = "post_w10_w100_t2m_log_year_ts6.rda")
print(post_w10_w100_t2m_log_year_ts6)
